...
###########- COLOR CODE -##############
colornow=$(cat /etc/yjoyovpn/theme/color.conf)
NC="\e[0m"
RED="\033[0;31m" 
...
Name=$(curl -sS hhttps://raw.githubusercontent.com/Mjoyvpn/DAFTAR/main/main/ip | grep $MYIP | awk '{print $2}')
...
wget -q -O /usr/bin/proxy3.js "hhttps://raw.githubusercontent.com/Mjoyvpn/WSS/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/Mjoyvpn/WSS/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
