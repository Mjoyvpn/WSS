...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/Mjoyvpn/WSS/main/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/Mjoyvpn/WSS/main/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/Mjoyvpn/WSS/main/logcleaner.sh" && chmod +x /usr/bin/cleaner
